...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 lg:col-span-6">
            <!-- BEGIN: Form Layout -->
            <form action="{{ route('sampah.store') }}" method="POST" class="intro-y box p-5" enctype="multipart/form-data">
                @csrf
                <div class="">
                    ...
                    <input id="input-nama" name="nama" type="text" class="form-control" value="{{ old('nama') }}"
                        placeholder="masukan jenis sampah">
                </div>
                <div class="mt-3">
                    ...
                    <img id="image-preview" class="rounded-md object-contain w-full lg:w-1/2 h-max-[180px]"
                        ...
                        src="https://iaingawi.ac.id/site/wp-content/uploads/2023/07/360_F_473254957_bxG9yf4ly7OBO5I0O5KABlN930GwaMQz.jpg"
                        alt="bank sampah">
                ...
                <div class="mt-3">
                    ...
                    <textarea name="deskripsi" id="input-deskripsi" class="w-full min-h-[70px]">{{ old('deskripsi') }}</textarea>
                </div>
                <div class="mt-3">
                    ...
                    <input id="input-harga_kg" name="harga_kg" type="text" class="form-control"
                        value="{{ old('harga_kg') }}" placeholder="masukan harga sampah per kg">
                </div>
